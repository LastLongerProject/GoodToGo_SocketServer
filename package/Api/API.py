...
class Api:
    ...
    def login(self, username, password):
        ...
        r = requests.post(baseUrl+self.ver+Uri.login,
    ...
    def fetchSocketNamespaceAndToken(self):
        ...
        Retrun values - status code(number), 
                        ...
                        real uri(string)                         
        '''
        headers = {'Authorization': Jwt.standard(
            self.secretKey), 'apiKey': self.apiKey}
    ...
    def reloadContainer(self, id, storeId):
        ...
        '''
        headers = {'Authorization': Jwt.addDate(
            self.secretKey), 'apiKey': self.apiKey, 'Content-Type': 'application/json'}
        r = requests.post(baseUrl+self.ver+Uri.reloadContainer +
                          str(id), headers=headers, json={'storeId': storeId})
    ...
    def returnContainer(self, id, storeId):
        ...
        headers = {'Authorization': Jwt.addDate(
            self.secretKey), 'apiKey': self.apiKey, 'Content-Type': 'application/json'}
        r = requests.post(baseUrl+self.ver+Uri.returnContainer +
                          str(id), headers=headers, json={'storeId': storeId})
    ...
    def rentContainer(self, id, userApiKey):
        ...
        '''
        headers = {'Authorization': Jwt.addDate(
            self.secretKey), 'apiKey': self.apiKey, 'userApiKey': userApiKey}
        r = requests.post(baseUrl+self.ver+Uri.lendContainer +
    ...
    def createDeliveryStockBox(self, ids):
        ...
        headers = {'Authorization': Jwt.standard(
            self.secretKey), 'apiKey': self.apiKey, 'Content-Type': 'application/json'}
        r = requests.post(baseUrl+self.ver+Uri.createStockBox, headers=headers,
    ...
    def modifyDeliveryBoxInfo(self, boxId, body):
        ...
        headers = {'Authorization': Jwt.standard(
            self.secretKey), 'apiKey': self.apiKey, 'Content-Type': 'application/json'}
        r = requests.post(baseUrl+self.ver+Uri.modifyDeliveryBoxInfo +
                          str(boxId), headers=headers, json=body)
        return (r.status_code)
    ...
    def modiftDeliveryBoxState(self, boxId, newState):
        ...
        headers = {'Authorization': Jwt.standard(
            self.secretKey), 'apiKey': self.apiKey, 'Content-Type': 'application/json'}
        r = requests.post(baseUrl+self.ver+Uri.modifyDeliveryBoxState, headers=headers,
    ...
    def signDeliveryBox(self, boxId):
        ...
        headers = {'Authorization': Jwt.standard(
            self.secretKey), 'apiKey': self.apiKey, 'Content-Type': 'application/json'}
        r = requests.post(baseUrl+self.ver+Uri.signDeliveryBox, headers=headers,
